...
import {FILTER_CHAT_LIST_BY_STRING} from "../../../../store/chat/actionTypes";
...
const ChatFilteringInput = () => {
    ...
    const filterByString = () => {
        ...
        dispatch({
            type: FILTER_CHAT_LIST_BY_STRING,
            payload: {
    ...
    return (
        <div className="row">
            <div className="col-11 col-md-10 col-lg-9 col-xl-9 mx-auto" style={{display: "flex"}}>
                ...
                />
                <button className="btn btn-primary my-3 ml-2" onClick={filterByString}>Найти</button>
            </div>
        </div>
    )
}
