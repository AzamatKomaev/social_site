...
export class GroupChatPath {
    ...
    static messages_list = (chatId: number): string => {
        return `${defaultUrl}/group_chats/${chatId}/messages/`
    }
...
export class PersonalChatPath {
    ...
    static messages_list = (userId: number): string => {
        return `${defaultUrl}/personal_chats/${userId}/messages/`
    }
}
