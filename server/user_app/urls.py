...
urlpatterns = [
    ...
    path('user/register/', views.UserViewSet.as_view({"post": "create_registration_user"})),
    path('user/is_auth/', views.UserViewSet.as_view({"get": "retrieve_current_user"})),
    path('user/accept/<str:token>/', views.UserViewSet.as_view({"patch": "accept_registration_user"})),
