...
urlpatterns = [
    ...
    # path('group_chats/<int:chat_id>/', include([
    #     path('messages/', views.GroupMessageModelViewSet.as_view({
    ...
    #     path('members/<int:role_id>/', views.GroupChatRoleModelViewSet.as_view({"get": "retrieve"})),
    #     path('requests/', views.GroupChatRequestModelViewSet.as_view({
    #         "get": "list",
    #         "patch": "update"
    #     }), name='group_chats_requests.list'),
    #     path('requests/<int:user_id>/', views.GroupChatRequestModelViewSet.as_view({
    #         "get": "retrieve",
    #         "post": "create",
    #         "delete": "destroy"
    ...
    path('group_chats/<int:chat_id>/members/', views.GroupChatRoleModelViewSet.as_view({"get": "list"}),
         name='group_chat_members.list'),
    path('group_chats/<int:chat_id>/members/<int:role_id>/', views.GroupChatRoleModelViewSet.as_view({
        "get": "retrieve"
