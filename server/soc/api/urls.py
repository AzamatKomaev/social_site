...
urlpatterns = [
    ...
    path('chats/<int:chat_id>/request/', chat_views.GroupChatRequestViewSet.as_view({
                                                                    "get": "list_requests",
                                                                    "patch": "update"
                                                            })),
    path('chats/<int:chat_id>/request/<int:user_id>/', chat_views.GroupChatRequestViewSet.as_view({
                                                                                            "get": "detail_request",
                                                                                            "post": "create",
                                                                                            "delete": "destroy"
                                                                                        })),
